module.exports = {
  ...
  moduleNameMapper: {
    "\\.(png|jpg|ico|jpeg|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$": "<rootDir>/__mocks__/ImageMock.js",
  },
  modulePathIgnorePatterns: ['<rootDir>/packages/'],
  preset: 'react-native',
  setupFiles: ["<rootDir>/node_modules/react-native-gesture-handler/jestSetup.js", './jest.setup.js'],
